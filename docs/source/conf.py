...
htmlhelp_basename = "InteligenciaArtificial2013AprendizajeporRefuerzodoc"
...
latex_documents = [
    (
        "index",
        "InteligenciaArtificial2013AprendizajeporRefuerzo.tex",
        "Inteligencia Artificial 2013: Aprendizaje por Refuerzo Documentation",
        "Grupo Nº 1",
        "manual",
    ),
]
...
man_pages = [
    (
        "index",
        "inteligenciaartificial2013aprendizajeporrefuerzo",
        "Inteligencia Artificial 2013: Aprendizaje por Refuerzo Documentation",
        ["Grupo Nº 1"],
        1,
    )
