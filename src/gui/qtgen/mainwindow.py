...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem4 = QtGui.QSpacerItem(5, 10, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        ...
        self.btnInicializar = QtGui.QPushButton(self.groupBox_4)
        self.btnInicializar.setObjectName(_fromUtf8("btnInicializar"))
        self.gridLayout_9.addWidget(self.btnInicializar, 1, 1, 1, 1)
        self.btnGenValAleatorios = QtGui.QPushButton(self.groupBox_4)
        self.btnGenValAleatorios.setObjectName(_fromUtf8("btnGenValAleatorios"))
        self.gridLayout_9.addWidget(self.btnGenValAleatorios, 0, 1, 1, 1)
        ...
        spacerItem8 = QtGui.QSpacerItem(35, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem8, 3, 0, 1, 1)
        spacerItem9 = QtGui.QSpacerItem(35, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnInicializar.setText(_translate("MainWindow", "Inicializar valores", None))
