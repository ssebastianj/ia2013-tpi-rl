...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem = QtGui.QSpacerItem(35, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        MainWindow.setTabOrder(self.sbQLGamma, self.cbQLTecnicas)
