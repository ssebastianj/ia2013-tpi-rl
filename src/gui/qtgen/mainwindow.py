...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_20.addWidget(self.gbMatrices, 0, 1, 1, 1)
        ...
        self.gridLayout_20.addWidget(self.gbAgente, 0, 0, 1, 1)
        ...
        self.gbCOAnimacion = QtGui.QGroupBox(self.dockWidgetContents_2)
        self.gbCOAnimacion.setObjectName(_fromUtf8("gbCOAnimacion"))
        self.gridLayout_28 = QtGui.QGridLayout(self.gbCOAnimacion)
        self.gridLayout_28.setContentsMargins(-1, 4, -1, 6)
        ...
        self.btnCOAnimCancel = QtGui.QPushButton(self.gbCOAnimacion)
        self.btnCOAnimCancel.setMaximumSize(QtCore.QSize(80, 16777215))
        self.btnCOAnimCancel.setObjectName(_fromUtf8("btnCOAnimCancel"))
        self.gridLayout_27.addWidget(self.btnCOAnimCancel, 0, 0, 1, 1)
        self.lblCODelay = QtGui.QLabel(self.gbCOAnimacion)
        self.lblCODelay.setObjectName(_fromUtf8("lblCODelay"))
        self.gridLayout_27.addWidget(self.lblCODelay, 0, 2, 1, 1)
        spacerItem9 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_27.addItem(spacerItem9, 0, 1, 1, 1)
        self.sbCOAnimDelay = QtGui.QDoubleSpinBox(self.gbCOAnimacion)
        self.sbCOAnimDelay.setSuffix(_fromUtf8(""))
        self.sbCOAnimDelay.setMaximum(30.0)
        self.sbCOAnimDelay.setObjectName(_fromUtf8("sbCOAnimDelay"))
        self.gridLayout_27.addWidget(self.sbCOAnimDelay, 0, 3, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.gbCOAnimacion, 1, 0, 1, 1)
        spacerItem12 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_25.addItem(spacerItem12, 2, 0, 1, 1)
        ...
        self.lblCODelay.setBuddy(self.sbCOAnimDelay)
        ...
        MainWindow.setTabOrder(self.sbCOAnimDelay, self.btnInicializarValoresQL)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gbCOAnimacion.setTitle(_translate("MainWindow", "Animación", None))
        self.btnCOAnimCancel.setText(_translate("MainWindow", "Animar", None))
        self.lblCODelay.setText(_translate("MainWindow", "Delay:", None))
