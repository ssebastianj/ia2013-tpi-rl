...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_23.addItem(spacerItem3, 2, 0, 1, 1)
        self.label_18 = QtGui.QLabel(self.gbQLMatrizQ)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_18.sizePolicy().hasHeightForWidth())
        self.label_18.setSizePolicy(sizePolicy)
        self.label_18.setMinimumSize(QtCore.QSize(158, 0))
        self.label_18.setObjectName(_fromUtf8("label_18"))
        self.gridLayout_23.addWidget(self.label_18, 2, 1, 1, 1)
        ...
        self.sbValOptimoIncremento.setMaximum(10000)
        ...
        self.label_18.setBuddy(self.sbValOptimoIncremento)
        ...
        QtCore.QObject.connect(self.optMQInitValOptimistas, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.label_18.setEnabled)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkLimitarCantIteraciones.setToolTip(_translate("MainWindow", "<html><head/><body><p>Determina si se limitará la cantidad de iteraciones por cada episodio.</p></body></html>", None))
        ...
        self.sbMatricesMinDiff.setToolTip(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Diferencia mínima entre matrices Q</span></p><p align=\"center\">Establece la diferencia mínima que tiene que haber entre una Matriz Q (en t= i) y otra Matriz Q (en t= i+1) para que se detenga la ejecución del algoritmo.</p></body></html>", None))
        ...
        self.label_18.setText(_translate("MainWindow", "Valor ópt. = Rec. Estado Final +", None))
