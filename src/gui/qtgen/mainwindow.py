...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget.setLocale(QtCore.QLocale(QtCore.QLocale.Spanish, QtCore.QLocale.Argentina))
        ...
        self.gridLayout_17.addWidget(self.groupBox_7, 3, 0, 1, 2)
