...
#
# Created: Tue Apr 09 18:03:17 2013
...
class Ui_GenRndValsDialog(object):
    def setupUi(self, GenRndValsDialog):
        ...
        self.gridLayout.addWidget(self.checkBox, 1, 1, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.radioButton_2, 0, 0, 1, 2)
        ...
        GenRndValsDialog.setTabOrder(self.radioButton, self.checkBox)
        GenRndValsDialog.setTabOrder(self.checkBox, self.radioButton_2)
        GenRndValsDialog.setTabOrder(self.radioButton_2, self.checkBox_2)
        GenRndValsDialog.setTabOrder(self.checkBox_2, self.radioButton_3)
        GenRndValsDialog.setTabOrder(self.radioButton_3, self.btnGenRndVals)
    ...
    def retranslateUi(self, GenRndValsDialog):
        ...
        self.checkBox.setText(_translate("GenRndValsDialog", "Dimensión aleatoria", None))
        self.radioButton.setText(_translate("GenRndValsDialog", "Estados aleatorios de diferente tipo", None))
        self.checkBox_2.setText(_translate("GenRndValsDialog", "Técnica aleatoria", None))
        self.radioButton_2.setText(_translate("GenRndValsDialog", "Valores de los parámetros", None))
        self.radioButton_3.setText(_translate("GenRndValsDialog", "Ambos", None))
