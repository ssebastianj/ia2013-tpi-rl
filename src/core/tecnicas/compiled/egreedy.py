...
from core.tecnicas.compiled import cgreedy
...
class EGreedy(QLTecnica):
    ...
    def obtener_accion(self, vecinos):
        ...
        """
        return cgreedy.obtener_accion(vecinos, self._val_param_parcial)
    ...
    def elegir_estado_aleatorio(self, lista_estados):
        ...
        """
        return cgreedy.elegir_estado_aleatorio(lista_estados)
